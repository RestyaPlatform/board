...
function sendMail($template, $replace_content, $to, $reply_to_mail = '')
{
    ...
    if ($template) {
        ...
        $headers.= "X-Mailer: Restyaboard (0.4.1; +http://restya.com/board)" . PHP_EOL;
    ...
    if (!empty($board)) {
        ...
        if (!empty($board['actions'])) {
            ...
            foreach ($board['actions'] as $action) {
                ...
                if (empty($action['data']['list']['id']) && empty($action['data']['card']['id'])) {
                    $qry_val_arr = array(
                        $created,
                        $modified,
                        $new_board['id'],
                ...
                } else if (!empty($action['data']['list']['id']) && empty($action['data']['card']['id'])) {
                    $qry_val_arr = array(
                        $created,
                        $modified,
                        $new_board['id'],
