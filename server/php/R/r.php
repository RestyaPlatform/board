...
function r_post($r_resource_cmd, $r_resource_vars, $r_resource_filters, $r_post)
{
    ...
    $emailFindReplace = $response = $foreign_id = $cards = array();
...
function r_put($r_resource_cmd, $r_resource_vars, $r_resource_filters, $r_put)
{
    ...
    $emailFindReplace = $response = $diff = $pg_params = $foreign_ids = $revisions = $previous_value = $srow = array();
    $res_status = true;
    $sql = $json = false;
    unset($r_put['temp_id']);
    switch ($r_resource_cmd) {
