   ...
   /* :-[ / :-@  */ rage: /:-?[\[@]/g,
         ...
         /* :-1: */ thumbsdown: /:\-1:/g
            ...
            function insertEmojicon(node, match, emojiName) {
                ...
                if (typeof node.parentNode.className !== undefined && (node.parentNode.className.indexOf('js-card-emoji-name') != -1 || node.parentNode.className.indexOf('js-open-model-car-view') != -1 || node.parentNode.className.indexOf('js-search-card-emoji') != -1)) {
                    var span_element = document.createElement("SPAN");
                    var t = document.createTextNode(': ' + emojiName + ' :');
                    span_element.appendChild(t);
                    node.parentNode.insertBefore(span_element, node.nextSibling);
                } else {
