	...
	var Datetimepicker = function (element, options) {
		...
		if (this.isInline) {
			...
			if(options.timepicker === 1){
				this.picker.addClass('datepicker-dropdown datetimepicker-dropdown-' + this.pickerPosition + ' dropdown-menu timer-width');
			}else{
				this.picker.addClass('datepicker-dropdown datetimepicker-dropdown-' + this.pickerPosition + ' dropdown-menu');
			}
		}
		if (this.isRTL) {
