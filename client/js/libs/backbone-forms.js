...
Form.template = _.template('\
    <form class="form-horizontal">\
     <div data-fieldsets></div>\
      <% if (submitButton) { %>\
        <button type="submit" class="btn btn-primary js-custom-field-submit-btn"><%= submitButton %></button>\
      <% } %>\
    </form>\
...
Form.editors.DateTime = Form.editors.Base.extend({
  ...
  template: _.template('\
    <div class="bbf-datetime">\
      ...
      <select class="form-control" data-type="hour"><%= hours %></select>\
      :\
      <select class="form-control" data-type="min"><%= mins %></select>\
    </div>\
  ', null, Form.templateSettings),
