 ...
 */
App.EmojiListView = Backbone.View.extend({
    template: JST['templates/emoji_list'],
    tagName: 'ul',
    className: 'dropdown-menu dropdown-menu-left arrow col-xs-12',
    /**
     * Events
