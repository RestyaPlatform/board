...
const pkgdef :Spk.PackageDefinition = (
  ...
  id = "416s6gqcqstgv4yq87xcp3dqqt5qaq3pnvrxvfqzge4f03kg8fgh",
  ...
  manifest = (
    ...
    appTitle = (defaultText = "Restyaboard"),

    appVersion = 0,  # Increment this for every release.

    appMarketingVersion = (defaultText = "0.6.6"),
    ...
    metadata = (
      ...
      codeUrl = "https://github.com/RestyaPlatform/board",
      ...
      shortDescription = (defaultText = "Trello like kanban board. Based on Restya platform."),
