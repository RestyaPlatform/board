module.exports = function(grunt) {
    ...
    grunt.initConfig({
        ...
        zip: {
            'using-cwd': {
                src: ['manifest.xml', 'api_explorer/**/*.*', 'server/php/**/*.*', 'media/**/*.*', 'client/*.*', 'client/css/default.cache.*.css', 'client/js/default.cache.*.js', 'client/font/**/*.*', 'client/img/**/*.*'],
