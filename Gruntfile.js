module.exports = function(grunt) {
    ...
    var source_js_files = new Array('Gruntfile.js', 'client/js/collections/**/*.js', 'client/js/models/**/*.js', 'client/js/views/**/*.js', 'client/js/application.js', 'client/js/common.js', 'client/plugins/**/js/*.js');
    grunt.initConfig({
        ...
        exec: {
            beautify: {
                cmd: [
                    ...
                    'php build/beautifier.php client/plugins'
                ].join('&&')
            },
            i18n: {
                cmd: [
